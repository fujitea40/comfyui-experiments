...
class WorkflowManager:
    ...
    def create_configured_workflow(
        self, 
...
def example_usage():
    """使用例"""
    from models import NodeMapping, WorkflowConfig, GenerationParams, SamplerConfig, LoraConfig
    ...
    ksampler_info = manager.get_node_info(
        configured,
        manager.config.node_mapping.ksampler
    )
    if ksampler_info:
